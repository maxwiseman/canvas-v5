...
import {
	...
	wasRecentChipPress,
	wasRecentDrag,
} from "@canvas-v5/ui/components/reui/event-calendar/event-calendar-dnd";
import {
	EVENT_CALENDAR_GHOST,
	EVENT_CALENDAR_SLOT_DRAFT,
	EventCalendarEvent,
} from "@canvas-v5/ui/components/reui/event-calendar/event-calendar-event";
import {
	flattenResources,
	getDayKey,
	getDayTotalMinutes,
	...
	toZoned,
	zonedStartOfDay,
} from "@canvas-v5/ui/components/reui/event-calendar/event-calendar-lib";
import {
...
} from "@canvas-v5/ui/components/reui/event-calendar/event-calendar-types";
import { ScrollArea } from "@canvas-v5/ui/components/scroll-area";
